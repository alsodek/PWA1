...
console.log('------ strings ----------');
	...
	var num = 3;
	var testVariable = "He's in PWA1 " + num;
	console.log("Example 5: " + testVariable);
 ...
 ********************************************/
	...
	console.log("The sum of the numbers is: ", myArr[0] + myArr[1] + myArr[2] + myArr[3]);
...
*/
	...
	var myVar = 5 > 3;
	console.log("if 5 is greater than 3: ", myVar);
...
var moodFun = function(weather, waves){
	if(weather === "sunny"){
		if (waves === 10){
			bobsMood = "pumped";
		}else if ((waves <= 9) && (waves >= 5)){
	...
	var final = moodFun(value1, value2);
	
	console.log("Bob is", final)
